<template>
  <div class="container">
    ...
    <el-table :data="tableData" style="width: 100%">
      <el-table-column prop="workerNo" label="员工编号" width="180"></el-table-column>
      <el-table-column prop="cabinetName" label="收衣点名称" width="180"></el-table-column>
      <el-table-column prop="payMoney" label="支付总金额"></el-table-column>
      <el-table-column prop="orderCount" label="订单数量"></el-table-column>
      <el-table-column prop="clothsCount" label="衣物总件数"></el-table-column>
...
export default {
  ...
  methods: {
    search() {
      ...
      let url = "Manager.ashx?Function=HttpMinShopDisWorker";
      let data = {
      ...
      getclothesmsg.then(res => {
        ...
        if (res.data.State == "成功") {
          ...
          res.data.Body.map(item => {
            ...
            this.clothes += Number(item.clothsCount);
          });
        }
      });
    },
